...
const CATEGORY = "poisson" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Tous nos guides ${meta.label.toLowerCase()} : santé, aquarium, alimentation, maladies. Conseils vétérinaires pour vos ${meta.label.toLowerCase()}s.`,
...
export default async function PoissonPage({ params, searchParams }: PageProps) {
  const { locale } = await params;
