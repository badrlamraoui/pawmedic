...
const CATEGORY = "reptile" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Tous nos guides ${meta.label.toLowerCase()} : santé, alimentation, terrarium, comportement. Conseils vétérinaires pour votre ${meta.label.toLowerCase()}.`,
...
export default async function ReptilePage({ params, searchParams }: PageProps) {
  const { locale } = await params;
