...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Tous nos guides ${meta.label.toLowerCase()} : santé, alimentation, maladies, comportement. Conseils vétérinaires pour votre ${meta.label.toLowerCase()}.`,
...
export default async function FuretPage({ params, searchParams }: PageProps) {
  const { locale } = await params;
