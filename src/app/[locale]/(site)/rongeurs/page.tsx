...
const CATEGORY = "rongeurs" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Tous nos guides ${meta.label.toLowerCase()} : santé, alimentation, races, comportement, élevage. Conseils vétérinaires pour vos ${meta.label.toLowerCase()}.`,
...
export default async function RongeursPage({ params, searchParams }: PageProps) {
  const { locale } = await params;
